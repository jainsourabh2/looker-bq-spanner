...
view: txn_stats_top_10minute {
  ...
  measure: avg_commit_latency_seconds {
    ...
    link: {
      ...
      url: "https://emcedev.cloud.looker.com/dashboards-next/10?Fprint={{ txn_stats_top_10minute.fprint._value | url_encode }}&&Interval+End+Time={{ txn_stats_top_10minute.interval_end_time._value | url_encode}}"
